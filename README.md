...
- Sauvegarde locale via **localStorage** pour consultation après fermeture de l’application.  
...
- **GitHub** – versionning et gestion du projet  
...
4. Tests et débogage : vérification des fonctionnalités et compatibilité multi-écrans.  
5. Finalisation et documentation : commentaires dans le code, création du README.  

---

## 🎨 Interface
- Cartes colorées pour différencier revenus et dépenses.  
- Formulaire intuitif pour ajouter ou modifier des transactions.  
- Responsive design pour ordinateur, tablette et smartphone.  

---

## ⚠️ Difficultés rencontrées & solutions
- Gestion des transactions dynamiques → JavaScript pour calcul automatique  
- Sauvegarde des données après fermeture → localStorage  
- Interface responsive → CSS flexbox / grid  
- Lisibilité des transactions → cartes colorées et espacement suffisant  

---

## 📈 Perspectives
- Authentification multi-utilisateurs  
- Visualisation graphique des transactions (diagrammes, graphiques)  
- Export des transactions (CSV, PDF)  
- Amélioration du design et ajout d’animations  
